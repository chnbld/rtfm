...
parser.add_argument('--rgb-list', default='list/train.list', help='list of rgb features ')
...
parser.add_argument('--dataset-name', default='Child-Abuse', help='dataset to train on (default: )')
